...
data class ShoppingList(
    ...
    companion object{
        ...
        @Keep
        enum class ReminderInterval(val text:String,val textBangla:String,val textHindi:String,val intervalMs:Long?){
            ONCE("Once","শুধুমাত্র একবার","सिर्फ एक बार",null),
            MIN_15("15 minutes","15 মিনিট","15 मिनट",15*DateUtils.MINUTE_IN_MS),
            MIN_30("30 minutes","30 মিনিট","30 मिनट",30*DateUtils.MINUTE_IN_MS),
            HOUR_1("1 hour","1 ঘণ্টা","1 घंटा",1*DateUtils.HOUR_IN_MS),
            HOUR_6("6 hours","6 ঘণ্টা","6 घंटा",6*DateUtils.HOUR_IN_MS),
            HOUR_24("24 hours","24 ঘণ্টা","24 घंटा",24*DateUtils.HOUR_IN_MS);

            fun getText(language: SupportedLanguage):String{
                return when(language){
                    SupportedLanguage.ENGLISH -> text
                    SupportedLanguage.BANGLA -> textBangla
                    SupportedLanguage.HINDI -> textHindi
                }
